...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_fvyrulf', 'template_1lpuwtc', form.current, {
        publicKey: 'Plpjtpuu8MkrnkhkK',
      })
      .then(
        () => {
          console.log('SUCCESS!');
  ...
  return (
    <div id='Contact'>
      <div className="contact bg-black flex justify-center items-center flex-col gap-8 py-10">
        <div className='flex justify-center items-center'>
          <div className='flex items-center gap-2'>
            <div className='bg-orange-700 w-5 h-1 rounded-lg'></div>
            <span className='text-white text-2xl font-bold'>Contact Me</span>
          </div>
        </div>
        <form ref={form} onSubmit={sendEmail} className='flex flex-col justify-center items-center gap-4 w-1/2'>
          <input name='to_name' className='p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' type="text" placeholder='Name:' />
          <input name='from_email' className='p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' type="email" placeholder='Email:' />
          <textarea name='message' id="message" rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a comment..."></textarea>
          <button type='submit' className='bg-orange-700 hover:bg-orange-800 font-bold text-center text-2xl text-white px-6 py-2 rounded-3xl'>Send</button>
          <div className='flex items-center justify-center gap-4 my-3 py-2'>
            <a href="https://www.instagram.com/imanugyaverma" target="_blank"><svg className='hover:text-orange-800 cursor-pointer' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" color="#ffffff" fill="none">
            ...
            <a href="">
              <svg className='hover:text-orange-800 cursor-pointer' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" color="#ffffff" fill="none">
            ...
            <a href="https://www.linkedin.com/in/anugya-verma-431b82271" target='_blank'>
              <svg className='hover:text-orange-800 cursor-pointer' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" color="#ffffff" fill="none">
            ...
            <a href="https://mail.google.com/mail/u/0/?hl=en-GB&tf=cm&fs=1&to=anugyaverma9758@gmail.com" target='_blank'>
              <svg className='hover:text-orange-800 cursor-pointer' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" color="#ffffff" fill="none">
